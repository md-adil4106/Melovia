    ...
    <main className="min-h-screen aurora-bg text-white font-sans pb-24 selection:bg-[#fa2d55]/30 selection:text-white">
      ...
      <header className="border-b border-white/[0.08] bg-[#07080b]/75 backdrop-blur-2xl sticky top-0 z-40 transition-all">
        <div className="max-w-6xl mx-auto px-4 py-3.5 flex items-center justify-between">
          ...
          <nav className="flex items-center bg-white/[0.06] p-1 rounded-full border border-white/10 backdrop-blur-md" role="tablist">
            <button
              type="button"
              role="tab"
          ...
          <div className="flex items-center gap-2.5 text-xs">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-white/80 hover:text-white bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 px-3.5 py-1.5 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-white bg-gradient-to-r from-[#fa2d55]/15 to-[#8b5cf6]/15 hover:from-[#fa2d55]/25 hover:to-[#8b5cf6]/25 border border-[#fa2d55]/30 px-3.5 py-1.5 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55] shadow-sm"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-xs text-sky-200 hover:text-white bg-sky-500/15 hover:bg-sky-500/25 border border-sky-500/30 px-3.5 py-1.5 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-sky-400"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-white/80 hover:text-white bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 px-3.5 py-1.5 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
            >
            ...
            {healthData ? (
              <span className="flex items-center gap-1.5 text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 px-3 py-1 rounded-full text-xs">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                Catalog {healthData.catalog?.version || "ready"} ({healthData.catalog?.track_count?.toLocaleString() || 0} tracks)
              </span>
            ) : (
              <span className="flex items-center gap-1.5 text-amber-300 bg-amber-500/10 border border-amber-500/30 px-3 py-1 rounded-full text-xs">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-8">
        ...
        <section className="relative overflow-hidden rounded-3xl p-8 sm:p-10 mb-8 border border-white/[0.08] bg-gradient-to-b from-white/[0.05] to-white/[0.015] backdrop-blur-2xl text-center shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          <HeroParticleField />
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/[0.06] border border-white/10 text-xs text-[#fa2d55] mb-3 backdrop-blur-md shadow-sm font-medium">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2.5">
              ...
              {SAMPLE_PRESETS.map((preset) => (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 hover:border-[#fa2d55]/50 text-white transition-all transform active:scale-95 shadow-sm backdrop-blur-md"
        ...
        {!onboardingDismissed && (
          <div className="mb-6 p-5 bg-white/[0.035] border border-white/10 rounded-2xl relative shadow-xl backdrop-blur-xl animate-in fade-in duration-300">
            <button
              type="button"
              onClick={handleDismissOnboarding}
              aria-label="Dismiss quick start guide"
              className="absolute top-3.5 right-3.5 text-white/60 hover:text-white p-1 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
            >
              <X className="w-4 h-4" />
            </button>
        ...
        <section className="bg-white/[0.035] backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-6 sm:p-7 mb-8 shadow-[0_16px_40px_rgba(0,0,0,0.5)] relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-black/40 border border-white/10 hover:border-white/20 rounded-2xl px-5 py-3.5 text-sm text-white placeholder-white/40 focus:outline-none focus:border-[#fa2d55] focus:ring-4 focus:ring-[#fa2d55]/20 transition-all shadow-inner backdrop-blur-md disabled:opacity-50"
            />
            ...
            {isDropdownOpen && debouncedQuery.length >= 2 && (
              <div
                ref={dropdownRef}
                className="absolute left-0 right-0 top-full mt-2 bg-[#0c0e14]/95 backdrop-blur-2xl border border-white/15 rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.85)] z-50 overflow-hidden max-h-88 overflow-y-auto"
              >
                    ...
                    {searchResults.map((t, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-3.5 py-3 rounded-xl flex items-center justify-between gap-3.5 transition-all ${
                            isHighlighted ? "bg-white/[0.1]" : "hover:bg-white/[0.06]"
                          } ${isAlreadySeed ? "opacity-40 cursor-not-allowed" : ""}`}
                        >
                          <div className="flex items-center gap-3.5 min-w-0 pr-2">
                            <div className="relative w-11 h-11 rounded-xl bg-white/[0.05] border border-white/10 flex items-center justify-center flex-shrink-0 text-[#fa2d55] overflow-hidden shadow-md">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="flex items-center gap-2 text-xs text-white/60 truncate mt-0.5">
                                ...
                                {t.tags && t.tags.length > 0 && (
                                  <span className="text-[10px] bg-white/[0.06] text-white/70 px-2 py-0.5 rounded-full border border-white/10 hidden sm:inline">
                                    {t.tags[0]}
                                  </span>
                                )}
                              </div>
                          ...
                          <div className="flex items-center gap-1.5 text-xs flex-shrink-0">
                            {isAlreadySeed ? (
                              ...
                              <span className="inline-flex items-center gap-1 text-xs bg-white/[0.08] hover:bg-[#fa2d55] hover:text-white px-3 py-1.5 rounded-full text-white/90 transition-all font-semibold active:scale-95 shadow-sm">
            ...
            {seeds.length === 0 ? (
              ...
              <div className="flex flex-wrap items-center gap-2">
                {seeds.map((s) => (
                  <div
                    key={s.id}
                    className="inline-flex items-center gap-2.5 bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 rounded-full px-3 py-1.5 text-xs text-white shadow-sm backdrop-blur-md animate-in fade-in duration-200"
                  >
                    <div className="relative w-5 h-5 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0 text-[#fa2d55] overflow-hidden">
                    ...
                    <button
                      ...
                      className="text-white/60 hover:text-rose-400 p-0.5 rounded-full transition-colors focus:outline-none focus:ring-1 focus:ring-rose-400"
                    >
            ...
            <div className="flex items-center gap-3">
              ...
              {(hasPersistentProfile || seeds.length === 0) && (
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 hover:border-white/20 text-white font-semibold text-xs px-4 py-2.5 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55] disabled:opacity-40"
                >
                  <Sparkles className="w-3.5 h-3.5 text-[#fb7185]" />
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 bg-gradient-to-r from-[#fa2d55] via-[#e11d48] to-[#be123c] hover:from-[#ff375f] hover:to-[#d01344] text-white font-bold px-7 py-3 rounded-full shadow-[0_4px_24px_rgba(250,45,85,0.45)] hover:shadow-[0_6px_32px_rgba(250,45,85,0.65)] transition-all transform active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none"
              >
        ...
        {recommendations.length > 0 && (
          <div className="sticky top-[61px] z-30 bg-[#0c0f17]/85 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 sm:p-5 mb-8 shadow-[0_16px_40px_rgba(0,0,0,0.6)] transition-all">
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/[0.05] border border-white/10 hover:border-white/20 text-white/80 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/25 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-400"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-sky-500/15 border border-sky-500/30 text-sky-200 hover:bg-sky-500/25 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-400"
                >
                ...
                <button
                  type="button"
                  onClick={() => setChatDrawerOpen(true)}
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-purple-500/15 border border-purple-500/30 text-purple-200 hover:bg-purple-500/25 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400"
                ...
                <span
                  ...
                  className="font-mono text-xs font-bold text-[#fa2d55] bg-[#fa2d55]/15 border border-[#fa2d55]/30 px-2.5 py-0.5 rounded-full shadow-[0_0_10px_rgba(250,45,85,0.2)]"
                >
        ...
        {appliedConstraints.length > 0 && (
          <div className="flex items-center gap-2 mb-5 flex-wrap p-3.5 rounded-2xl bg-purple-950/30 border border-purple-500/30 shadow-sm backdrop-blur-xl animate-in fade-in">
            ...
            {appliedConstraints.map((c) => (
              <span
                key={c.id}
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-black/40 text-zinc-200 border border-purple-500/30 shadow-sm"
              >
                ...
                <button
                  ...
                  className="text-zinc-400 hover:text-red-400 p-0.5 rounded-full transition-colors"
        ...
        <section className="mb-20">
            ...
            {recommendations.length > 0 && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-semibold text-white/80 hover:text-white bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 px-3.5 py-1.5 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
                >
                  <Download className="w-3.5 h-3.5" />
                  <span>Export</span>
                </button>
                <span className="text-xs text-white/60 bg-white/[0.04] px-3 py-1 rounded-full border border-white/10">
          ...
          {recommendMutation.isPending && (
            <div className="space-y-3">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-4 flex items-center justify-between animate-pulse"
                >
                  ...
                  <div className="w-16 h-6 bg-white/[0.08] rounded-full" />
                </div>
              ))}
            </div>
          )}
          ...
          {!recommendMutation.isPending && recommendations.length === 0 && (
            <div className="border border-dashed border-white/15 rounded-3xl p-12 text-center bg-white/[0.02] backdrop-blur-md">
              <div className="w-16 h-16 rounded-2xl bg-white/[0.05] border border-white/10 flex items-center justify-center mx-auto mb-4 text-[#fa2d55]">
            ...
            <div className="space-y-3">
              {recommendations.map((item: RecommendedItem, idx: number) => {
                ...
                return (
                  <article
                    key={item.track.id}
                    className="bg-white/[0.025] border border-white/[0.06] hover:border-white/[0.16] rounded-2xl p-3.5 sm:p-4 transition-all duration-250 ease-out motion-reduce:transition-none hover:bg-white/[0.065] hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      <span className="w-7 text-center font-mono text-xs font-semibold text-white/40 group-hover:text-white/70">
                        #{idx + 1}
                      </span>
                      <div className={`relative w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#fa2d55] flex-shrink-0 overflow-hidden group/art shadow-[0_4px_16px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-all duration-300 ${
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-2.5 pl-10 sm:pl-0 flex-wrap">
                      ...
                      {novPct !== null && (
                        <div
                          className="flex items-center gap-1.5 text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-white/[0.04] border border-white/10"
                      ...
                      {/* Audio channel badge */}
                      {item.track.has_a ? (
                        <span className="text-[10px] text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 px-2 py-0.5 rounded-full font-mono">
                          Audio
                        </span>
                      ) : (
                        <span className="text-[10px] text-white/40 bg-white/[0.04] border border-white/10 px-2 py-0.5 rounded-full font-mono">
                          No Audio
                        </span>
                      )}

                      {/* Match Score Badge */}
                      <div className="flex items-center gap-1.5 bg-gradient-to-r from-[#fa2d55]/15 to-[#8b5cf6]/15 border border-[#fa2d55]/30 px-3 py-1 rounded-full shadow-sm">
                      ...
                      {item.track.preview_url ? (
                        <button
                          ...
                          className={`inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full border transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55] ${
                            playingTrackId === item.track.id
                      ...
                      <div className="flex items-center gap-1 bg-white/[0.04] border border-white/10 rounded-full p-0.5 backdrop-blur-md">
                        {/* Like button */}
                        <button
                          type="button"
                          onClick={() =>
                          ...
                          className={`p-1.5 rounded-full transition-all focus:outline-none focus:ring-1 focus:ring-[#fa2d55] ${
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-full transition-all focus:outline-none focus:ring-1 focus:ring-red-400 ${
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-full text-white/60 hover:text-white hover:bg-white/10 transition-colors focus:outline-none focus:ring-1 focus:ring-white/40"
                        >
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-full transition-all focus:outline-none focus:ring-1 focus:ring-[#8b5cf6] ${
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full bg-white/[0.05] hover:bg-white/[0.12] border border-white/10 text-white/80 hover:text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#fa2d55]"
                      >
      ...
      {tasteShiftedMessage && (
        <div
          ...
          role="status"
          aria-live="polite"
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-[#0c0f17]/90 border border-[#fa2d55]/50 text-white shadow-[0_12px_32px_rgba(0,0,0,0.6)] backdrop-blur-2xl text-xs font-semibold animate-in fade-in slide-in-from-bottom-3"
        >
          <Sparkles className="w-4 h-4 text-[#fa2d55]" />
